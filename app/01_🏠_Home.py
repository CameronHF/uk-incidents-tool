...
st.markdown('Purpose: Automation of the process of identifying and resolving incidents in the production line, '
...
st.markdown('This page allows you to query the production data from the DWH. You can select a date range and a recipe '
